...
public class PreExpandedValidationSupportLoader {
	public PreExpandedValidationSupportLoader(ValidationSupportChain theValidationSupport, FhirContext theFhirContext) {
		var preExpandedValidationSupport = new PreExpandedValidationSupport(theFhirContext);
		theValidationSupport.addValidationSupport(0, preExpandedValidationSupport);
	}
}
